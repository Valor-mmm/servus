...
- [x] Containment data model & orphan handling
- [x] Quantity / atomic mutation paths
- [x] Category-schema storage & evolution
- [x] migrate-item-containment script safety
- [x] Export/import round-trip integrity
- [x] Live-data migration risk summary
- [x] Summary written
