...
| 5a  | Import/export (high-priority, derived from #5 discussion) | **Fix**                                                   | Spec: `add-import-export`. Web admin page at `/admin` — export downloads NDJSON to browser, import uploads NDJSON file. Accessible from phone; no CLI required.                                                                                                                                                   |
...
2. **`add-import-export`** — web admin page at `/admin`; export downloads NDJSON
   snapshot to browser, import accepts NDJSON file upload. Accessible from
   phone.
